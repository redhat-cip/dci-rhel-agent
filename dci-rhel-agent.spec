...
install -p -D -m 644 rpms/redhat-certification-hardware-spicegate-0.1-20180720.el7.noarch.rpm %{buildroot}%{_sysconfdir}/dci-rhel-agent/redhat-certification-hardware-spicegate.noarch.rpm
install -p -D -m 644 rpms/yum-plugin-copr-1.1.31-45.el7.noarch.rpm %{buildroot}%{_sysconfdir}/dci-rhel-agent/yum-plugin-copr.noarch.rpm
