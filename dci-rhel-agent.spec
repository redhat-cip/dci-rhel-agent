...
install -p -d -m 644 %{buildroot}%{_sysconfdir}/dci-rhel-agent/dci-rhel-agent
...
%{_sysconfdir}/dci-rhel-agent/Dockerfile
%dir %{_sysconfdir}/dci-rhel-agent/dci-rhel-agent
