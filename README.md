...
This file should NOT be edited (unless you know exactly what you are doing):
...
| local_repo | False | Path | Path to directory where components will be stored; Must be exposed by httpd. Default is `/var/www/html`. |
