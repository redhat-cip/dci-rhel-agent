...
If a new machine is added to a partner DCI lab, simply enter its information in the beaker_lab.system_inventory section of the settings.yml file and run the agent.  The agent will add and configure this new system in Beaker according to the information provided in settings.
