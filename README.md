# DCI RHEL Agent
`dci-rhel-agent` provides Red Hat Enterprise Linux (RHEL) within Red Hat DCI service.
...
There is no reliable way to know your team automatically. So please contact us back when you reach this step, we will manually move your user in the correct organisation.
