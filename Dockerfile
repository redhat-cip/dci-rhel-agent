...
RUN yum-config-manager --disableplugin=subscription-manager --add-repo https://beaker-project.org/yum/beaker-server-RedHatEnterpriseLinux.repo
RUN yum-config-manager --disableplugin=subscription-manager --add-repo https://beaker-project.org/yum/harness/RedHatEnterpriseLinux7/
