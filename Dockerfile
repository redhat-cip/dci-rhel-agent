...
RUN yum -y install gcc ansible python python2-devel python2-pip beaker-client beaker-lab-controller ansible-role-dci-import-keys ansible-role-dci-retrieve-component dci-ansible
RUN yum clean all
